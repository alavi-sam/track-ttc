...
@dag(
    dag_id='scan_bronze_layer_files_trips',
    schedule_interval="0 * * * *",
    default_args={
        'owner': 'Sam',
...
def scan_trips_bronze_layer_files():
    
    BUCKET_NAME = 'trip-bronze-layer'
    TABLE_NAME = 'trip_bronze_files'
    ...
    def scan_bucket(bucket_name: str, **kwargs):
        ...
        prefix = f"trip/year={year}/month={month}/day={day}/hour={hour}/"
